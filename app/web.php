...
//Pega info user
//curl -v -X GET "http://talaka-pre-alpha-gmastersupreme-1.c9users.io/exec/visitor/profile/23"

//Login User
//curl -v -X POST "http://talaka-pre-alpha-gmastersupreme-1.c9users.io/exec/client/auth" -H "Content-Type: application/json"  -d '{"login":"caroles","pwd":"12345"}'

//Lista New Project
//curl -v -X GET "http://talaka-pre-alpha-gmastersupreme-1.c9users.io/exec/visitor/pesqNew/6"

//Inserir Comentario
//curl -v -X POST "http://talaka-pre-alpha-gmastersupreme-1.c9users.io/exec/client/comments/7" -H "Content-Type: applicati -/json" -d '{"cd_project":19,"ds_comment":"alooooo"}'
