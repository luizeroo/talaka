...
<head>
    ...
    <link href="/view/web-sass/style.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="resources/font-awesome/css/font-awesome.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="/view/js/script.js" type="text/javascript"></script>
    <script src="/view/js/front.js" type="text/javascript"></script>
	...
	<link href="/view/js/lib/keyboard/css/keyboard.css" rel="stylesheet">
	<script src="/view/js/lib/keyboard/js/jquery.keyboard.js"></script>

	<!-- keyboard extensions (optional) -->
	<script src="/view/js/lib/keyboard/js/jquery.mousewheel.js"></script>
	<script src="/view/js/lib/keyboard/js/jquery.keyboard.extension-typing.js"></script>
	<script src="/view/js/lib/keyboard/js/jquery.keyboard.extension-autocomplete.js"></script>
