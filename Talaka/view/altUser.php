...
?>
<main id='linkMain'>
<div class='wrapper profileAlter' id='profileAlter'>
        <div id='profileUser'>
            <h1>Perfil</h1>
            ...
            <form method='post' action=''>
                <label for='upload'>Upar novo avatar</label>
                    <input type='file' id='upload' name="altImg">
        ...
        <div id='profileInfos'>
            ...
            <form>
                ...
                <label for='alteremail'>Email</label>
                    <input id='alteremail' type='text' placeholder='email atual do usuário' <?= 'value="'.$email.'"';?>>
